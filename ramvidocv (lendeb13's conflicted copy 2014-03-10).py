...
socket.send('SetSessionName<test>')
#ProcessorCommunication <processor name> <command>
#%% SERIAL FOR OE
...
import serial
ser = serial.Serial('/dev/ttyS3', 115200, timeout=1)  # open first serial port
